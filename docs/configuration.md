...
FM_ARM_CONFIRM_TIMEOUT=10   # seconds fm-watch-arm allows a fresh watcher in each startup phase (lock, identity, beacon) before reporting FAILED; default 30 on Git Bash/MSYS
