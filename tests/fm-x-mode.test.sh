...
test_poll_auth_error_reports_once() {
  ...
  fm_test_assert_private_mode "$home/state" 700 "poll auth error must create private state" dir
  fm_test_assert_private_mode "$home/state/x-poll.error" 600 "poll auth error marker must be private"
  out=$(PATH="$fakebin:$BASE_PATH" FM_HOME="$home" FMX_RELAY_URL="https://relay.test" \
    FAKE_POLL_CODE=401 \
    "$ROOT/bin/fm-x-poll.sh"); rc=$?
...
test_poll_mentions_wake_once_per_durable_offer() {
  ...
  fm_test_assert_private_mode "$marker" 600 "the durable offer marker must be a private file"
...
test_poll_inbox_private_publication_rejects_unsafe_paths() {
  ...
  fm_test_assert_private_mode "$dir" 700 "poll must create the inbox directory as private" dir
  fm_test_assert_private_mode "$dir/req-x.json" 600 "poll must publish the inbox file as private"
...
test_reply_dry_run_outbox_private_publication_rejects_unsafe_paths() {
  ...
  fm_test_assert_private_mode "$home/state/x-outbox" 700 "reply dry-run must create the outbox directory as private" dir
  fm_test_assert_private_mode "$home/state/x-outbox/req-x.json" 600 "reply dry-run must publish the outbox file as private"
  assert_no_private_artifact_temps "$home/state/x-outbox"
...
test_context_registry_private_publication_rejects_unsafe_paths() {
  ...
  fm_test_assert_private_mode "$home/state/x-context" 700 "context registry must create the context directory as private" dir
  fm_test_assert_private_mode "$home/state/x-context/req-x.json" 600 "context registry must publish the context file as private"
  assert_no_private_artifact_temps "$home/state/x-context"
...
test_private_artifact_publisher_runs_under_system_bash() {
  ...
  fm_test_assert_private_mode "$home/state/x-outbox/req-bash.json" 600 \
...
test_dismiss_dry_run_outbox_private_publication_rejects_unsafe_paths() {
  ...
  fm_test_assert_private_mode "$home/state/x-outbox" 700 "dismiss dry-run must create the outbox directory as private" dir
  fm_test_assert_private_mode "$home/state/x-outbox/req-x.json" 600 "dismiss dry-run must publish the outbox file as private"
  assert_no_private_artifact_temps "$home/state/x-outbox"
